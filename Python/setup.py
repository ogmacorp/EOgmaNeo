...
class install_subclass(install):
    description = "Building the EOgmaNeo C++ library, generating SWiG bindings, and installing neo"
...
class build_ext_subclass(build_ext):
    description = "Building the C-extension for PyEOgmaNeo with CMake"
    ...
    def get_ext_path(self, name):
        ...
        package_dir = build_py.get_package_dir('eogmaneo')
    ...
    def build_extensions(self):
        ...
        if not self.inplace:
            ...
            self._found_names = []
            built_ext = self.get_ext_name("_eogmaneo")
            if os.path.exists(built_ext):
                ...
                self._found_names.append("_eogmaneo")

                built_py = self.get_py_name("eogmaneo")
